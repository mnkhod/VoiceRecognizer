	...
	box.push(x);
      ...
      var grammar = '#JSGF V1.0; grammar colors; public <color> = ' + box.join(' | ') + ' ;'
	...
	$('header').attr('style',`background-color:${colorChange(color)} !important`);
	$('footer').attr('style',`background-color:${colorChange(color)} !important`);
	$('button').attr('style',`background-color:${colorChange(color)} !important`);
	$('#content').text(color);
